...
public class UserControllerTest extends DummyObject{
    ...
    @BeforeEach //모든 메서드가 실행되기 직전에 실행
    public void setUp(){
        dataSetting();
    }
    ...
    public void join_success_test() throws Exception{
        ...
        String requestBody = om.writeValueAsString(joinReqDto); // JSON 변경
    ...
    public void join_fail_test() throws Exception{
        ...
        String requestBody = om.writeValueAsString(joinReqDto); // JSON 변경
        System.out.println("join_fail_test 테스트 : "+ requestBody);

        // when
        ResultActions resultActions = mvc.perform(post("/api/join").content(requestBody).contentType(MediaType.APPLICATION_JSON));
        String responseBody = resultActions.andReturn().getResponse().getContentAsString();
        System.out.println("join_fail_test 테스트 : "+ responseBody);
